            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Documentation For Clafiya First Phase of Recruitment Test</h1>
	                        <p class="hero-paragraph">Laravel Passport Authentication api that validates a user's email address or phone number and password and returns the users data and passport tokens.</p>
					...
					<div class="features-inner section-inner has-bottom-divider">
						<div class="features-header text-center">
							<div class="container-sm">
								<h2 class="section-title mt-0">The Documentation</h2>
	                            <p class="section-paragraph">This App is Hosted on Heroku(Ubuntu server, using nginx server) and the following Authentication endpoints can be tested with Postman.</p>								
							</div>
                        </div>
        ...
        <footer class="site-footer has-top-divider">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2022 Clafiya Test, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
